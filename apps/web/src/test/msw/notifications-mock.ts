...
export function seedNotifications(): void {
  ...
  mockNotifications.items = [
    make(
      5,
      'warn',
      'Высокая нагрузка на CPU · de-fra-01: ждёт «Да»',
      'CPU держится на 96% дольше 5 мин (порог 90%). Предложено: Перезапустить контейнер ноды (T2), первый шаг цепочки. Нажмите «Да» в инциденте.',
