 ...
 * пост-проверка → откат; не помогло — предлагает следующий шаг цепочки (T2 ждёт «Да», T3 —
 ...
 * T2 — с подтверждением («Да» в панели, без пароля — решение владельца); T3 — только вручную,
